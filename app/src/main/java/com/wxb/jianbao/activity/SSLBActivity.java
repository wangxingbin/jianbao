...
import com.wxb.jianbao.adapter.SSLBAdapter;
...
public class SSLBActivity extends Activity {
    ...
    private void initData() {
        ...
        Log.e("sdhkfjsnl;kfdn", Constant.CHAXUN + "?curPage=" + curPage + "&title=" + str);
        //封装的okhttp工具类
        myOkhttp.doRequest(Constant.CHAXUN + "?curPage=" + curPage + "&title=" + str,
